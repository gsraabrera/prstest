...
class AuditTrailTable
{
	...
	function __construct()
	{
		...
		$this->logTableName = ProjectSettings::getSecurityValue( 'auditAndLocking', 'loggingTable', 'table' );
		if( ProjectSettings::getSecurityValue( 'auditAndLocking', 'lockAfterUnsuccessfulLogin' ) ) {
			$this->attLogin=3;
			$this->timeLogin=5;
		}
		$userid="";
    ...
    public function logSecurity() {
		return ProjectSettings::getSecurityValue( 'auditAndLocking', 'logSecurityActions' );
	}
	...
	* format audit values as a string
	...
	function logValueEnable($table)
	{
		...
		return $tableSettings && $tableSettings['logFieldValues'];
	}
...
class AuditTrailFile
{
	...
	function __construct()
	{
		...
		$this->logfile = ProjectSettings::getSecurityValue( 'auditAndLocking', 'loggingFile' );
