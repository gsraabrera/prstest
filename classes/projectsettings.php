...
//		global $tables_data, $field_labels, $fieldToolTips, $placeHolders, $page_titles, $detailsTablesData, $masterTablesData, $bSubqueriesSupported;
	...
	*/
	...
	static function azureBlobName() {
		return ProjectSettings::getProjectValue( 'cloudSettings', 'cloudAzureAccountName' );
	}

	static function azureBlobKey() {
		return ProjectSettings::getProjectValue( 'cloudSettings', 'cloudAzureAccountKey' );
	}

	static function azureBlobContainer() {
		return ProjectSettings::getProjectValue( 'cloudSettings', 'cloudAzureContainer' );
	}
