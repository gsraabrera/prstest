...
$caseSensitivity = $ajaxSearchCaseInsensitive ? dsCASE_INSENSITIVE : dsCASE_DEFAULT;
if( !$searchByLinkField ) {
	$displayFieldCondition = $pSet->getCustomDisplay( $field ) 
		? DataCondition::SQLIs( $displayFieldName, $operation, $value, $caseSensitivity )
		: DataCondition::FieldIs( $displayFieldName, $operation, $value, $caseSensitivity );
