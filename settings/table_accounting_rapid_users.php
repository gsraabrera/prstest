...
$runnerTableSettings['public.accounting_rapid_users'] = array(
	...
	'afterEditDetails' => 'public.accounting_rapid_users',
	'afterAddDetail' => 'public.accounting_rapid_users',
...
FROM
	...
	'fields' => array(
		'id' => array(
			...
			'tableName' => 'public.accounting_rapid_users' 
		),
		'username' => array(
			'name' => 'username',
			'goodName' => 'username',
...
FROM
	"public".accounting_rapid_users',
		...
		'fieldList' => array( 
			array(
				...
				'expression' => array(
					...
					'parsed' => true,
					'type' => 'SQLField',
					'table' => 'public.accounting_rapid_users',
					'name' => 'id' 
				),
				'encrypted' => false,
				'columnName' => 'id' 
		...
		'fromList' => array( 
			array(
				'sql' => '"public".accounting_rapid_users',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".accounting_rapid_users',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.accounting_rapid_users'] = array(
	'tableCaption' => 'Accounting Rapid Users',
	'fieldLabels' => array(
		'id' => 'Id',
		'username' => 'Username',
		'password' => 'Password',
